...
<head>
    ...
    <title>Adidas Predator 20.3 FG-Core Black</title>
...
<div class="small-container single-product">
  <div class="row">
    <div class="col-2">
      <img src="adidaspredator20.3.jpg" width="100%">
    </div>
    <div class="col-2">
      <p>Home / Shoes</p>
      <h1>Adidas Predator 20.3 FG-Core Black</h1>
      <h4>$100.00</h4>
      <select>
      ...
      <br>
      <p>Seize your unfair advantage and take control in these adidas Predator Mutator 20.3 football boots.
         The mid cut design and foot hugging upper support your stance to help you own the pitch.
         3D print elements rise from the forefoot to inject accuracy into every strike</p>
    </div>
  </div>
</div>
