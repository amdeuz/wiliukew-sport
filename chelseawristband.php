...
<div class="small-container single-product">
  <div class="row">
    <div class="col-2">
      <img src="chelseawristband.jpg" width="100%">
    </div>
    <div class="col-2">
      <p>Home / Accesories</p>
      <h1>Chelsea Wristband</h1>
      <h4>$5.00</h4>
      <select>
      ...
      <br>
      <p>Chelsea f.c. Silicone wristband- silicone rubber wristband- one size fits all- approx 7cm in diameter- on a header card- official licensed product </p>
    </div>
  </div>
</div>
