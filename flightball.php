...
<head>
    ...
    <title>Nike Flight Ball Premier League</title>
...
<div class="small-container single-product">
  <div class="row">
    <div class="col-2">
      <img src="flightball.jpg" width="100%">
    </div>
    <div class="col-2">
      <p>Home / Ball</p>
      <h1>Nike Flight Ball Premier League</h1>
      <h4>$25.00</h4>
      <select>
      ...
      <br>
      <p>Honed over 8 years and 1,700 hours of testing, the Nike Flight Football is a revolution in consistent flight.
        Moulded grooves and 3D-printed ink fine-tune flight through the air to help players put the ball exactly where they want it. </p>
    </div>
  </div>
</div>
