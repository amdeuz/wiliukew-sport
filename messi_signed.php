...
<div class="small-container single-product">
  <div class="row">
    <div class="col-2">
      <img src="messisigned.jpg" width="100%">
    </div>
    <div class="col-2">
      <p>Exclusive Barcelona Jersey Signed By Lionel Messi</p>
      <h1>Lionel Messi Barcelona FC Autographed Jersey</h1>
      <h4>$1000.00</h4>
      <select>
      ...
      <br>
      <p>Take home this FC Barcelona Club Jersey - signed by soccer legend and one-time FIFA Player of the year Lionel Messi. Messi has signed the back of the jersey making it a unique collector's item.. </p>
    </div>
  </div>
</div>
