...
<body>
  ...
  <div class="small-container">
    ...
    <div class="row">
      ...
      <div class="col-4">
        <img src="chelsea.jpg">
        <a href="chelseajersey.php"><h4>Chelsea Jersey Home 2020/21</h4></a>
        <div class= "rating">
          <i class="fa fa-star"></i>
          <i class="fa fa-star"></i>
          <i class="fa fa-star"></i>
      ...
      <div class="row">
        <div class="col-4">
          <img src="mu.jpg">
          <a href="mujersey.php"><h4> Manchester United Jersey Home 2020/21 </h4></a>
          <div class= "rating">
            <i class="fa fa-star"></i>
            <i class="fa fa-star-half-o"></i>
            <i class="fa fa-star-o"></i>
        ...
        <div class="col-4">
          ...
          <a href="flightball.php"><h4> Nike Flight Ball Premier League </h4></a>
          <div class= "rating">
            <i class="fa fa-star"></i>
            <i class="fa fa-star"></i>
            <i class="fa fa-star"></i>
        ...
        <div class="col-4">
          ...
          <a href="superfly.php"><h4> Nike Mercurial Superfly VI Elite Firm Ground </h4></a>
          <div class= "rating">
            <i class="fa fa-star"></i>
            <i class="fa fa-star"></i>
            <i class="fa fa-star"></i>
        ...
        <div class="col-4">
          ...
          <a href="chelseawristband.php"><h4> Chelsea Wristband </h4></a>
          <div class= "rating">
            <i class="fa fa-star"></i>
            <i class="fa fa-star"></i>
            <i class="fa fa-star"></i>
