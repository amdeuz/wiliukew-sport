...
<head>
    ...
    <title>Nike Mercurial Superfly VI Elite FG</title>
...
<div class="small-container single-product">
  <div class="row">
    <div class="col-2">
      <img src="nikemercurialsuperfly.jpg" width="100%">
    </div>
    <div class="col-2">
      <p>Home / Shoes</p>
      <h1>Nike Mercurial Superfly VI Elite Firm Ground</h1>
      <h4>$100.00</h4>
      <select>
      ...
      <br>
      <p>The Flyknit construction of the Nike Superfly 6 Elite FG wraps underneath your foot for an all-enveloping, second-skin-like fit straight out of the box.
        The two-part podular plate system utilises a lightweight internal chassis that flexes for speed with every step.</p>
    </div>
  </div>
</div>
